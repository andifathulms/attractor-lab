...
Next per `DESIGN-REWORK.md`'s build order: `VerifiedConstants` tolerance strips (§4), and a shared error surface for worker failure and boundedness-guard trips (§5).
